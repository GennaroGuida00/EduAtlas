package EduAtlas.security;

import EduAtlas.entities.User;
import EduAtlas.exceptions.UnauthorizedException;
import EduAtlas.servicies.UserService;
import EduAtlas.tools.JWTTools;
...
public class JWTCheckerFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        if(new AntPathMatcher().match("/auth/**", request.getServletPath())){
    return true;
        }
